...
const Profile = ({ type, name, avatar, email, properties }: ProfileProps) => (
  <Box>
    <Typography fontSize={25} fontWeight={700} color="#11142D">{type} Perfil</Typography>
              ...
              <Stack direction="column" gap="30px">
                <Stack gap="15px">
                  ...
                  <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                    ...
                    <Typography fontSize={14} color="#11142D">300 Recife - Pernambuco</Typography>
                  </Box>
                </Stack>

                <Stack direction="row" flexWrap="wrap" gap="20px" pb={4}>
                  <Stack flex={1} gap="15px">
                    <Typography fontSize={14} fontWeight={500} color="#808191">Telefone</Typography>
                    <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
    ...
    <Box
      ...
      bgcolor="#FCFCFC"
    >
      <Typography fontSize={18} fontWeight={600} color="#11142D">{type} Projetos</Typography>
